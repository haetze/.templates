...
#+LATEX_HEADER: \declaretheorem[name=Beweis, refname={Beweis}, Refname={Beweis}]{beweis}
#+LATEX_HEADER: \declaretheorem[name=Definition, refname={Definition,theorems}, Refname={Definition,Theorems}]{definition}
#+LATEX_HEADER: \declaretheorem[name=Theorem, refname={Satz}, Refname={Satz}]{theorem}
...
#+LATEX_HEADER: \affil[1]{Fakultät für Informatik, Technische Universität Dortmund\\ \href{mailto:richard.stewing@tu-dortmund.de}{richard.stewing@tu-dortmund.de}}
#+LANGUAGE: de
